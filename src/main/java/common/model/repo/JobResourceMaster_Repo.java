...
@Query(value = "select count(*) from JOB_RESOURCE_MASTER b where (b.resource_seq_no=:resourceSeqNo and b.mode_seq_no=:modeSeqNo and b.JOB_SEQ_NO=:jobSeqNo and b.TARGET_SEQ_NO=:tSeqNo and b.fr_loc_seq_no=:frLocSeqNo and b.to_loc_seq_no=:toLocSeqNo)",nativeQuery = true) 
Float getCountOfResourcesForJobResourceDetails(@Param("jobSeqNo") Long jobSeqNo,@Param("resourceSeqNo") Long resourceSeqNo,@Param("tSeqNo") Long tSeqNo,@Param("modeSeqNo") Integer modeSeqNo,@Param("frLocSeqNo") Long frLocSeqNo,@Param("toLocSeqNo") Long toLocSeqNo,@Param("jobItemMode") String jobItemMode);
}