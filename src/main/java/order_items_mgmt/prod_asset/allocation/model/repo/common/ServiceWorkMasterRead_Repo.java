...
@Repository("serviceWorkReadRepoForResources")
public interface ServiceWorkMasterRead_Repo extends JpaRepository<ServiceWorkMaster, Long> {
	...
	CopyOnWriteArrayList<ServiceWorkMaster> getSelectWorksBetweenTimes(@Param("frDtTm") Timestamp frDtTm,
	...
	CopyOnWriteArrayList<ServiceWorkMaster> getSelectJobServices(
			@Param("servWorkSeqNos") CopyOnWriteArrayList<Long> servWorkSeqNos);

	@Query(value = "SELECT * FROM JOB_MASTER where REQUEST_SEQ_NO in :reqSeqNos ORDER BY SERVICE_WORK_SEQ_NO", nativeQuery = true)
	CopyOnWriteArrayList<ServiceWorkMaster> getSelectJobServicesForRequests(
			@Param("reqSeqNos") CopyOnWriteArrayList<Long> reqSeqNos);
	...
	CopyOnWriteArrayList<ServiceWorkMaster> getJobsToBeScheduledForRequests(
			@Param("reqSeqNos") CopyOnWriteArrayList<Long> reqSeqNos);
	...
	CopyOnWriteArrayList<ServiceWorkMaster> getSelectJobServicesForServices(
			@Param("servSeqNos") CopyOnWriteArrayList<Long> servSeqNos);
	...
	CopyOnWriteArrayList<ServiceWorkMaster> getJobServiceForRefNos(
			@Param("jobrefIds") CopyOnWriteArrayList<String> jobrefIds);
	...
	CopyOnWriteArrayList<ServiceWorkMaster> getSelectJobServicesBetweenTimes(@Param("frDtTm") Timestamp frDtTm,
			@Param("toDtTm") Timestamp toDtTm);
